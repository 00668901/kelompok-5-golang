...
// --- Data Dummy GLOBAL (Ingat: data ini akan hilang setiap kali fungsi dipanggil ulang!) ---
var rooms = []Room{
	{
		ID:          "1",
...
// Data dummy reservasi (diinisialisasi dengan data awal)
...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	// Path: /, api, rooms/reservations, [id]
	...
	case "reservations":
		...
		// Cek jika ada ID di URL (/api/reservations/{id})
		id := ""
	...
	default:
		// 404 Not Found untuk path yang tidak dikenal
		w.WriteHeader(http.StatusNotFound)
